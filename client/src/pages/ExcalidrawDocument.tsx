...
const ExcalidrawDocument: React.FC = () => {
  return (
    <div className="bg-background text-on-background min-h-screen font-body selection:bg-primary/30 selection:text-primary">
      {/* TopAppBar */}
      <header className="bg-[#0e0e0e] fixed top-0 w-full z-50 border-b border-[#484848]/15 flex items-center justify-between px-6 h-16">
        <div className="flex items-center gap-4">
          <button className="text-primary hover:bg-[#2c2c2c] transition-colors duration-150 p-2 rounded bg-transparent border-none cursor-pointer">
            <span className="material-symbols-outlined">menu</span>
          </button>
          <h1 className="font-headline tracking-tighter uppercase text-2xl font-black text-white m-0">VAULT</h1>
        </div>
        <div className="flex items-center gap-2">
          <button className="text-[#ababab] hover:bg-[#2c2c2c] transition-colors duration-150 p-2 rounded bg-transparent border-none cursor-pointer">
      ...
      {/* BottomNavBar */}
      <nav className="bg-[#131313] fixed bottom-0 left-0 w-full flex justify-around items-center pb-safe border-t border-outline-variant/15 z-50 h-20">
        <a className="flex flex-col items-center justify-center text-[#ababab] hover:text-white transition-all no-underline" href="#">
